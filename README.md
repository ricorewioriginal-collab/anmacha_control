...
| **Intelligente Rotation, Clock-Templates, Preflight, Hard/Soft-Timing** | ⬜ offen | Noch nicht begonnen |
| **AirDeckCast** (eigene Streaming-/Verteilschicht, HLS, alternative Profile, Teststream) | ⬜ offen | Bisher Icecast/laut.fm/Relay direkt, keine eigene Bündelschicht |
